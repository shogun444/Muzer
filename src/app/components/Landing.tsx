...
const childVariant = {
 ...
 animate :{
  ...
  <div className="flex justify-center ">
          <img width={1180}  className="rounded-2xl " src="/Pro1.webp" alt="" />
        </div>
      <motion.div 
      initial={{
        y : 100,
      ...
      className="text-center px-64 mt-10 pb-10">
        <h1 className="text-neutral-200 text-5xl font-semibold pt-10">
          Everything in one place

        </h1>
        <h1 className="font-semibold text-neutral-500  pt-5">
