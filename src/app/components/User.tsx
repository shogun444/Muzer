...
<motion.div className="space-x-2">
  ...
  <button className="font-semibold text-sm ">{!session && <div className="flex"><div 
   onClick={()=>signIn()}
  className="text-semibold hover:bg-neutral-200 hover:text-neutral-800 hover:rounded-xl px-3 py-2 hover:cursor-pointer ">Login</div>
