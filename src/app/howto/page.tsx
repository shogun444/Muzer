...
export default function Howto(){
  return(<>
  <div className="mx-23  bg-gradient-to-br from-[#141415] via-[#1e2022] to-[#111d20] ">
         <Navbar />


        <h1 className="text-5xl text-center font-semibold text-neutral-300 my-10">How to Add Videos: Step-by-Step Guide</h1>

        <h2 className="max-w-4xl mx-auto text-neutral-400  mt-10">Looking to add your favorite YouTube videos to Muser? Whether you're curating playlists, remixing audio, or just exploring content, adding a video is fast and effortless with Muser’s user-friendly interface.
<br /><br />
...
Open https://muser.yourapp.com (or your actual domain) in a new tab.
