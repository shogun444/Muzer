      ...
      <div className="flex justify-center items-center px-4 py-10">
        <div className="w-full sm:w-[90%] md:w-[70%] max-w-md border-2 border-neutral-700 rounded-md p-6 sm:p-8 md:p-10 space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-center text-neutral-100 text-sm sm:text-base">Create your free account with</h2>
            ...
            >
              ...
              <span  className="text-black font-medium">
                {loading ? <LoaderCircle className="animate-spin"/> : ' Sign up with Google'}
               </span>
            </button>
          </div>
